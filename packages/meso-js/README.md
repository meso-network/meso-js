...
```sh
Content-Security-Policy: frame-src https://transfer.sandbox.meso.network/; connect-src https://transfer.sandbox.meso.network/;
```

**Production:**

```sh
Content-Security-Policy: frame-src https://transfer.meso.network/; connect-src https://transfer.meso.network/;
```
